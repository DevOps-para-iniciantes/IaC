...
2) Adentrar a pasta **parte5** do projeto clonado
...
Com o projeto executado, o resultado final obtido será o mesmo dos projetos utilizados nas partes 3 e 4, sem nenhuma alteração.
